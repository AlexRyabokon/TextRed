...
*/
    ...
    /*
     * Метод записи в новый файл (33.txt) с одного из двух исходных файлов.
     * File file - файл в который осуществяется запись
     * String str - строка получаемая из метода readFiles
     */
    ...
    /*
     * Метод читает данные из файла и возвращает в строке.
     */
